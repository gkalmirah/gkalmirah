          ...
          <form method="post" enctype="multipart/form-data">
             ...
             <?php
                    ...
                    if(isset($_GET['order_id'])){
                      ...
                      if(mysqli_num_rows($run) > 0){
                              ...
                              $upi_provider  = $order_row['upi_provider'];
                              $upi_id        = $order_row['upi_id'];
              ...
              if(isset($msg)){
                    ...
                    echo "<span class='mt-3 mb-5' style='color:green; font-weight:bold;'><i style='color:green; font-weight:bold;' class='fad fa-smile'></i> $msg</span>";
            ...
            <div class="row">
              ...
              <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                      <label for="size">Payment Method:</label>
                      <input type="text" class="form-control" value="<?php echo htmlspecialchars($payment_method); ?>" disabled>
                      </div>
                    </div>
                    <?php if($payment_method === 'UPI'): ?>
                    <div class="col-md-4">
                      <div class="form-group">
                      <label for="size">UPI Provider:</label>
                      <input type="text" class="form-control" value="<?php echo htmlspecialchars($upi_provider); ?>" disabled>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                      <label for="size">UPI ID:</label>
                      <input type="text" class="form-control" value="<?php echo htmlspecialchars($upi_id); ?>" disabled>
                      </div>
                    </div>
                    <?php endif; ?>
              </div> 
