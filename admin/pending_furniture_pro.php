        ...
        <div class="col-md-9">
            <div class="card shadow-sm border-0 mb-4 mt-4">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 font-weight-bold text-dark"><i class="fad fa-box-alt text-warning mr-2"></i> Pending Orders</h5>
                </div>
                                  ...
                                  <?php
                                    ...
                                    ?> 
                                     <tr>
                                         ...
                                         <td class="align-middle">
                                            <span class="badge badge-warning p-2"><i class="fad fa-clock mr-1"></i> Pending</span>
                                         </td>
                                   ...
                                   <?php 
                                        ...
                                        echo "<tr><td colspan='12' class='text-center text-muted py-5'><i class='fad fa-box-open fa-3x mb-3 d-block'></i><h5>No pending orders found</h5></td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
