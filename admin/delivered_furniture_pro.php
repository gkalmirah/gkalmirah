        ...
        <div class="col-md-9">
            <div class="card shadow-sm border-0 mb-4 mt-4">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 font-weight-bold text-dark"><i class="fad fa-truck text-success mr-2"></i> Delivered Orders</h5>
                </div>
                              ...
                              <?php
                                ...
                                ?> 
                                 <tr>
                                     ...
                                     <td class="align-middle">
                                        <span class="badge badge-success p-2"><i class="fad fa-check-circle mr-1"></i> Delivered</span>
                                     </td>
                               ...
                               <?php 
                                    ...
                                    echo "<tr><td colspan='11' class='text-center text-muted py-5'><i class='fad fa-box-open fa-3x mb-3 d-block'></i><h5>No delivered orders found</h5></td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
