...
<section style="margin-top:100px;">
     ...
     <?php if(isset($error)){
            ...
            echo "<span style='color:red; font-weight:bold;'><i style='color:red; font-weight:bold;' class='fad fa-frown'></i> $error</span>";

            }

            elseif(isset($msg)){

            echo "<span style='color:green; font-weight:bold;'><i style='color:red; font-weight:bold;' class='fad fa-frown'></i> $msg</span>";
